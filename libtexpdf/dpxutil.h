...
extern char *texpdf_parse_float_decimal (const char **pp, const char *endptr);
extern char *texpdf_parse_c_string      (const char **pp, const char *endptr);
extern char *texpdf_parse_c_ident       (const char **pp, const char *endptr);
