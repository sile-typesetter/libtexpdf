...
extern void     texpdf_init_resources  (void);
extern void     texpdf_close_resources (void);
...
extern pdf_obj *texpdf_get_resource_reference (long res_id);
#if 0
extern pdf_obj *texpdf_get_resource           (long res_id);
#endif
